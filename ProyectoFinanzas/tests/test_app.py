...
def test_create_valid_expense():
    app = FinanceManager()
    app.create_category("Comida")
    result = app.create_expense("Comida", 50.0, "Descripcion")
...
def test_create_valid_income():
    ...
    result = app.create_income("Salario", 5000.0, "Descripcion")
